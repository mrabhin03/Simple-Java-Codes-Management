...
?>
    ...
    <div class="card h-100">
        ...
        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
            <div class="text-center"><a class="btn btn-outline-dark mt-auto" style='background-color:white;' onclick='ResetValue()' href="CodeView.php?FileDetails=../<?php echo $file['Path'] ?>">View options</a></div>
        </div>
    </div>
    <?php
            }
